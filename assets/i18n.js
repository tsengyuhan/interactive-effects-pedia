...
(function () {
  ...
  const DICT = {
    "手機建議 iOS Safari 或 Android Chrome": "iOS Safari or Android Chrome recommended on phones",
    "免費使用，不需帳號或信用卡": "Free to use, with no account or credit card required",
    "想研究手機和電腦網頁的互動方式": "Exploring interactions between phone and desktop web pages",
    "來噴漆吧": "Spray Something",
    "把手機變成噴漆罐，轉向控制水泥牆上的霧粒塗鴉": "Turn your phone into a spray can and aim misty graffiti onto a concrete wall",
    "電腦開啟牆面，手機掃描 QR；啟用方向感測並朝向中央確認對位，下拉噴頭持續噴漆，放開即停。": "Open the wall on a computer and scan the QR with your phone. Enable motion, aim at the center and calibrate. Pull the nozzle down to spray; release to stop.",
    "以手機相對旋轉方向控制畫筆，避開直立角度跳躍；不追蹤手機平移。": "Relative phone rotation controls the brush without jumps at upright angles. It does not track translation.",
    "加密訊息經公開網路中繼傳送，心跳、配對與序號驗證避免失聯續噴。": "Encrypted messages travel through a public relay. Heartbeats, pairing and sequence checks stop painting after a lost connection.",
    "程序水泥紋理上疊加連續柔邊霧粒，停留會累積濃度與滴流。": "Continuous soft spray builds up on procedural concrete, with denser paint and drips when you linger.",
    "電腦與具方向感測器的手機，兩台皆需連網": "A computer and a phone with orientation sensors, both online",
    "手機需 HTTPS 與方向感測權限，不需相機或麥克風": "The phone needs HTTPS and orientation permission; no camera or microphone",
    "使用 HiveMQ 公開測試中繼，不保證可用性；請勿分享配對連結": "Uses the public HiveMQ test relay with no availability guarantee; keep your pairing link private",
    "手機配對需要連網，使用 HiveMQ 公開測試 MQTT 中繼，不保證可用性。": "Phone pairing requires internet and the public HiveMQ test MQTT relay, with no availability guarantee.",
    "水泥塗鴉牆": "Concrete graffiti wall",
    "掌心裡的噴漆罐": "A spray can in your palm",
    "音效開": "Sound on",
    "設定": "Settings",
    "音效關": "Sound off",
    "重試音效": "Retry sound",
    "此瀏覽器無法播放音效，可繼續噴漆。": "Sound is unavailable in this browser. You can still paint.",
    "音效已暫停，點「重試音效」恢復。": "Sound paused. Tap Retry sound to resume.",
    "開啟全螢幕": "Fullscreen",
    "退出全螢幕": "Exit fullscreen",
    "若無法全螢幕或鎖定直向，請使用手機系統的直向鎖定。": "If fullscreen or portrait locking is unavailable, use your phone's portrait orientation lock.",
    "請將手機轉回直向": "Please turn your phone upright",
    "啟用方向感測": "Enable motion",
    "確認對位": "Calibrate",
    "下拉噴頭並按住": "Pull the nozzle down and hold",
    "下拉噴頭並按住，放開即停噴": "Pull down and hold to spray. Release to stop.",
    "轉向靈敏度": "Sensitivity",
    "直立握住手機，左右轉向、上下抬低。不是平移追蹤。": "Hold your phone upright. Turn left or right, tilt up or down. Translation is not tracked.",
    "不使用相機或麥克風": "No camera or microphone",
    "正在連線至公開中繼…": "Connecting to the public relay…",
    "先啟用感測，再朝向電腦中央十字確認對位。": "Enable motion, then aim at the computer's center crosshair and calibrate.",
    "連線中斷，正在重新配對…": "Connection lost. Pairing again…",
    "連線恢復後，請重新確認對位。": "Calibrate again once the connection returns.",
    "請將手機朝向電腦中央十字，再按確認對位。": "Point your phone at the center crosshair, then tap Calibrate.",
    "正在配對…": "Pairing…",
    "已連線 · 朝向牆面開始創作": "Connected · Aim at the wall and create",
    "已有另一台手機連線，請等候它離線。": "Another phone is connected. Wait for it to disconnect.",
    "控制器使用中": "Controller in use",
    "配對連結無效，請重新掃描電腦上的 QR。": "Invalid pairing link. Scan the computer's QR again.",
    "需要 HTTPS 安全連線；本機測試請使用 localhost。": "A secure HTTPS connection is required. Use localhost for local tests.",
    "缺少本地 MQTT 程式庫，請確認部署檔案完整後重新整理。": "The local MQTT library is missing. Check the deployed files and reload.",
    "等待電腦回應…": "Waiting for the computer…",
    "無法啟動加密連線，請重新整理後重試。": "Could not start the encrypted connection. Reload to try again.",
    "手機感測需要 HTTPS，請從已部署的線上網址開啟。": "Phone motion requires HTTPS. Open the deployed online URL.",
    "此裝置沒有方向感測支援，請改用有感測器的手機。": "This device has no orientation support. Try a phone with motion sensors.",
    "方向感測權限被拒絕。請在瀏覽器設定允許後按重試。": "Motion permission was denied. Allow it in browser settings, then retry.",
    "等待方向感測資料，請輕輕轉動手機…": "Waiting for motion data. Gently turn your phone…",
    "重試感測": "Retry motion",
    "方向資料無效，請重試感測。": "Invalid orientation data. Retry motion.",
    "重新置中": "Recenter",
    "已對位。下拉噴頭，轉動手機畫出你的線條。": "Calibrated. Pull the nozzle down and turn your phone to draw.",
    "螢幕方向已改變，請重新確認對位。": "Screen orientation changed. Calibrate again.",
    "操作已暫停，請重新確認對位。": "Paused. Calibrate again to continue.",
    "噴漆顏色": "Spray color",
    "自訂噴漆顏色": "Custom spray color",
    "方向感測已逾時，請重試並重新確認對位。": "Motion data timed out. Retry and calibrate again.",
    "未收到方向資料。請確認感測權限，或換一台手機後重試。": "No orientation data received. Check motion permission or try another phone.",
    "把手機變成噴漆罐，讓每一道轉向留下色彩。": "Turn your phone into a spray can. Leave a little color with every move.",
    "你的手機，就是畫筆": "Your phone is the brush",
    "複製手機連結": "Copy phone link",
    "手機配對連結": "Phone pairing link",
    "連線說明與本機測試": "Connection and local testing",
    "兩台裝置都需連網。公開測試中繼不保證可用性，請勿分享配對連結。": "Both devices must be online. The public test relay has no availability guarantee. Keep your pairing link private.",
    "複製本機雙頁測試連結": "Copy local two-tab test link",
    "重新連線": "Reconnect",
    "滑鼠試噴顏色": "Mouse spray color",
    "清牆": "Clear wall",
    "按住滑鼠，也能試噴": "Hold the mouse to try spraying",
    "掃描 QR，啟用方向感測，再朝向中央十字確認對位。": "Scan the QR, enable motion, then aim at the center crosshair and calibrate.",
    "手機已連線": "Phone connected",
    "QR 程式庫尚未就緒，請先使用複製連結。": "The QR library is unavailable. Use Copy link for now.",
    "手機配對 QR": "Phone pairing QR",
    "QR 產生失敗，請使用複製連結。": "Could not generate the QR. Use Copy link.",
    "本機網址無法供手機使用。此 QR 指向正式站，需先部署本效果與程式庫。": "Phones cannot use localhost. This QR points to the live site; deploy this effect and its libraries first.",
    "連結已複製，請只交給你的控制手機。": "Link copied. Share it only with your controller phone.",
    "請手動複製下方連結。": "Copy the link below manually.",
    ...
    /* ── 爆炸頭 ─────────────────────────── */
    "爆炸頭": "Exploding Head",
    "放大五官貼滿實心球面，窄底端以原頸色羽化銜接；充氣與移頭驅動彈簧，爆炸成飄落薄片，留下固定不規則破口。": "Enlarged facial features cover an opaque sphere with a narrow, feathered neck-colored base. Pumping and head movement drive spring motion; the balloon bursts into falling flakes and leaves a stable ragged neck edge.",
    ...
    "幫整顆頭充氣直到爆炸，碎片飄落後留下即時無頭人像": "Inflate your whole head until it pops, then watch the pieces fall around your live headless portrait",
    "一個人正對鏡頭，讓頭髮與肩膀完整入鏡；連點下方打氣，爆炸後按重置再玩。可在資訊面板調整背景與充氣速度。": "Face the camera alone with your hair and shoulders in view. Tap Pump below, then Reset after the pop. Adjust the background and inflation speed in the info panel.",
    "本地人像分割與臉部偵測讀取同一影格，以前景頂緣估計含頭髮的頭部區域，分離頭部與身體。": "Local segmentation and face detection read the same frame. The foreground top edge helps estimate the head, including hair, and separate it from the body.",
    "按次累積氣量，以阻尼彈簧放大即時頭部；接近尺寸上限才切成人像碎片，搭配合成音效飄落。": "Each tap adds air. A damped spring enlarges the live head; near its size limit, it breaks into falling portrait pieces with synthesized sound.",
    "爆炸後持續追蹤並移除頭部；失去追蹤時暫停顯示人像，找回後維持爆炸狀態。": "Tracking keeps removing the head after the pop. The portrait is hidden if tracking is lost, and remains headless when tracking returns.",
    "單人正面；頭部輪廓為估算，長髮、側臉與遮擋可能殘邊": "One person facing forward; the head outline is approximate, so long hair, side views and occlusion may leave edges",
    "本地雙模型推論，手機或較舊裝置可能較慢；音效不需麥克風": "Two local vision models may run slowly on phones or older devices; sound needs no microphone",
    "事情太多感覺頭要爆炸了": "So much to do, it feels like my head is about to explode",
    "即時充氣人像": "Live inflatable portrait",
    "充氣進度": "Inflation progress",
    "打氣": "Pump",
    "充氣速度": "Inflation speed",
    "魚眼程度": "Fisheye strength",
    "主色調": "Main color",
    "小花上的臉部氣球": "A face balloon tied to a flower stem",
    "連點打氣，讓小花上的臉部氣球慢慢膨脹！": "Tap Pump to inflate the face balloon tied to the flower stem!",
    "小花素材載入失敗，請確認圖片完整後重新整理。": "The flower image could not load. Check that the image file is complete, then refresh.",
    "把你的臉變成繫在地上小花莖上的立體氣球，打氣直到爆炸": "Turn your face into a 3D balloon tied to a flower stem growing from the floor, then pump until it pops",
    "左右移頭或歪頭帶動氣球與小花擺動；連點打氣，碎片全部落地後才能重置。繩長可調 0.6–2.5 倍，另可調主色調、充氣速度、最大尺寸與魚眼程度。": "Move or tilt your head to swing the balloon and flower. Tap Pump, then wait for every piece to land before Reset. String length is adjustable from 0.6–2.5×, along with the main color, inflation speed, maximum size and fisheye strength.",
    "本地模型擷取即時五官，貼滿不透明立體氣球；兩面牆與地板自動配色，氣球繩綁在從地板長出的小花莖上。": "Local models wrap your live facial features around an opaque 3D balloon. Two walls and a floor use coordinated colors; the balloon string is tied to a small flower stem growing from the floor.",
    "氣球從花莖綁點垂直上浮，左右移頭與歪頭會讓整朵花跟著繩子擺動；繩長 0.6–2.5 倍，繩長約束、阻尼與微風讓球自然回穩。": "The balloon rises vertically from the flower-stem anchor. Moving or tilting your head swings the whole flower with the string; string length ranges from 0.6–2.5×, while constraints, damping and a light breeze settle the balloon naturally.",
    "把你的臉變成牆角消防栓上的立體氣球，打氣直到爆炸": "Turn your face into a 3D balloon tied to a hydrant in a room corner, then pump until it pops",
    "左右移頭或歪頭帶動氣球；連點打氣，碎片全部落地後才能重置。設定可調主色調、自動配色牆面、繩長、充氣速度、最大尺寸與魚眼程度。": "Move or tilt your head to swing the balloon. Tap Pump, then wait for every piece to land before Reset. Adjust the main color with matching walls, string length, inflation speed, maximum size and fisheye strength.",
    "本地模型擷取即時五官，貼滿不透明立體氣球；兩面牆與地板自動配色，保留寫實消防栓。": "Local models wrap your live facial features around an opaque 3D balloon. Two walls and a floor use coordinated colors beside the realistic hydrant.",
    "同一點光源將球影投向有限牆面與地板，接縫連續；碎片全部落地後，重置以陣風吹走再生成新球。": "One point light casts balloon shadows onto finite walls and the floor with continuous seams. Once all pieces land, Reset blows them away before creating a new balloon.",
    "繩長（倍）": "String length (×)",
    "消防栓素材載入失敗，請確認圖片完整後重新整理。": "The hydrant image could not load. Check that the image file is complete, then refresh.",
    "一個人正對鏡頭，左右移頭帶動氣球甩動；連點打氣，爆炸後按重置，風吹走碎片才生成新球。資訊面板可調背景、充氣速度、最大尺寸與魚眼程度。": "Face the camera alone and move your head sideways to swing the balloon. Tap Pump, then Reset after the pop: a gust clears the pieces before a new balloon appears. Adjust background, inflation speed, maximum size and fisheye strength in the info panel.",
    "近景街道共用地面透視，魚眼五官包覆立體球面並投影路面；碎片落地保留，重置時先由陣風吹走再生成新球。": "A close street view shares one ground perspective. Fisheye facial features wrap the shaded balloon, which casts a road shadow. Fallen flakes remain until Reset blows them away before creating the next balloon.",
    "吹走碎片中…": "Blowing pieces away…",
    "碎片飄落中…": "Pieces are falling…",
    "一個人正對鏡頭，左右移頭或歪頭帶動氣球；連點打氣，爆炸後等碎片全部落地才能重置，風吹走碎片才生成新球。資訊面板可調背景、充氣速度、最大尺寸與魚眼程度。": "Face the camera alone and move or tilt your head to move the balloon. Tap Pump, then wait for all pieces to land before Reset. A gust clears them before a new balloon appears. Adjust background, inflation speed, maximum size and fisheye strength in the info panel.",
    "氣球從綁點垂直上浮，左右移頭與眼睛連線傾角帶動甩動；繩長約束、阻尼與微風讓球自然回穩。": "The balloon floats vertically above its anchor. Sideways head movement and eye-line tilt drive its swing; string constraints, damping and a light breeze let it settle naturally.",
    "等待所有碎片落地後，就能重置。": "Wait for every piece to land before resetting.",
    "一陣風吹走碎片，準備下一顆氣球…": "A gust is clearing the pieces for the next balloon…",
    "背景顏色": "Background color",
    "效果已停止，請重新整理。": "The effect has stopped. Please reload.",
    "正在準備攝影機與本地模型…": "Preparing the camera and local models…",
    "分頁暫停中": "Tab paused",
    "追蹤遺失，已暫停顯示人像；請重新正對鏡頭。": "Tracking lost. The portrait is hidden; please face the camera again.",
    "請一個人正對鏡頭，讓頭髮與肩膀完整入鏡。": "Face the camera alone with your hair and shoulders fully in view.",
    "砰！移動看看無頭人像，按重置再玩一次。": "Pop! Move around to see your headless portrait. Press Reset to play again.",
    "快爆炸了…": "About to pop…",
    "連點打氣，讓整顆頭慢慢膨脹！": "Keep tapping Pump to inflate your whole head!",
    "人像處理失敗，請重新整理，或改用 Chrome／Edge。": "Portrait processing failed. Please reload or try Chrome / Edge.",
    "攝影機已中斷，請確認裝置連接後重新整理。": "The camera disconnected. Check the connection and reload.",
    "無法開啟攝影機，請允許攝影機權限、關閉占用相機的程式，再經 start.bat 或 HTTPS 開啟並重新整理。": "Cannot open the camera. Allow camera access, close other apps using it, then open via start.bat or HTTPS and reload.",
    "本地模型或影格載入逾時，請確認檔案完整後重新整理。": "Local models or camera frames took too long to load. Check the project files and reload.",
    "本地人像模型載入失敗，請確認 libs/mediapipe 檔案完整，並經 start.bat 或 HTTPS 開啟。": "Local portrait models failed to load. Check libs/mediapipe files and open via start.bat or HTTPS.",
    /* ── 站台 ─────────────────────────────── */
