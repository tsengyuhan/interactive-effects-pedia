...
(function () {
  ...
  const DICT = {
    ...
    "主色調": "Main color",
    "酒瓶上的臉部氣球": "A face balloon tied to a bottle",
    "連點打氣，讓酒瓶上的臉部氣球慢慢膨脹！": "Tap Pump to inflate the face balloon tied to the bottle!",
    "酒瓶素材載入失敗，請確認圖片完整後重新整理。": "The bottle image could not load. Check that the image file is complete, then refresh.",
    "把你的臉變成繫在酒瓶上的立體氣球，打氣直到爆炸": "Turn your face into a 3D balloon tied to a bottle, then pump until it pops",
    "本地模型擷取即時五官，貼滿不透明立體氣球；兩面牆與地板自動配色，氣球繫在裝有酒液的玻璃瓶頸。": "Local models wrap your live facial features around an opaque 3D balloon. Two walls and a floor use coordinated colors; the balloon is tied around the neck of a glass bottle containing liquor.",
