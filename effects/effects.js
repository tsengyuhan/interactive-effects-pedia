...
window.EFFECTS = [
  ...
  },
  {
    ...
    title: "草稿紙人像",
    category: "身體動作",
    description: "webcam 把人去背後畫在綠色作文稿紙上，鉛筆塗陰影排出人像；拖曳格線把稿紙撕開一條縫，縫內切換成連續鉛筆素描",
    instructions: "面對鏡頭，人像會以鉛筆塗法畫滿稿紙格子；在畫面上按住格線往左右或上下拖曳，稿紙會沿那條線撕開一條縫（拖曳點最寬、往兩端漸收），縫內變成同一個人的連續細緻素描，放開後自動闔上。可調整格子大小與線條濃度",
    tech: ["MediaPipe Image Segmenter", "getUserMedia", "Canvas 2D"],
    principle: [
      "人像分割模型即時把人從背景切出，只有人的區域會被作畫",
      "畫面縮到格子解析度取每格明暗，越暗的格子鉛筆塗得越濃（亮部留淡影讓輪廓成形）",
