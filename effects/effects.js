...
window.EFFECTS = [
  ...
  },
  {
    ...
    instructions: "面對鏡頭，伸出食指、收起中指與無名指，停住約半秒，指尖發光後就能在空中畫一個封閉形狀；路徑閉合後發光 1 秒，那塊畫面便掉落，洞裡透出套用特效的即時畫面。可連續切好幾刀，洞會累積，按右上角「重置世界」復原。可選洞內特效（科技像素／動態亂碼／印刷拼貼／色塊版畫），並調整特效顆粒與掉落速度",
    tech: ["MediaPipe Hands", "getUserMedia", "Canvas 2D"],
    principle: [
