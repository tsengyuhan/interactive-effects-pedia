...
window.EFFECTS = [
  ...
  },
  {
    ...
    instructions: "面對鏡頭並輸入文字。只有你一人時，文字繩一端釘在頭頂，先往上連到頭頂上方一個無形的點，再從那裡受重力垂下並隨你晃動；出現其他人時，文字繩會連到最靠近你的人的頭頂、拱成一道弧並讓文字持續流動，超過最遠連接距離就斷開成各自垂下的繩。可調文字大小、疏密、粗細、顏色、最遠連接距離、重力與單人繩長度",
    tech: ["MediaPipe Face Detector", "getUserMedia", "Canvas 2D", "Verlet 物理"],
    principle: [
      "FaceDetector 即時偵測畫面中每個人的頭部，跨幀以最近鄰配對維持身分",
      "單人繩用 Verlet：頭頂與其上方的無形錨點各釘一點，繃直往上後再受重力垂下晃動",
