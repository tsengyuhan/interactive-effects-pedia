...
window.EFFECTS = [
  ...
  },
  {
    ...
    title: "文字繩連連看",
    category: "身體動作",
    description: "輸入文字，單人時文字繩一端黏在鼻子上、另一端自由垂下隨頭晃動；多人時連接最靠近的兩顆頭並受重力下垂成弧，距離太遠會斷開",
    instructions: "面對鏡頭並輸入文字。只有你一人時，文字繩一端黏在你的鼻子上、另一端柔軟自由垂下，會隨著頭移動而晃動；出現其他人時，文字繩會連到最靠近你的人的頭頂、受重力在中間下垂成弧，超過最遠連接距離就斷開成各自垂下的繩。可調文字大小、疏密、粗細、顏色、最遠連接距離、重力、單人繩長度、晃動柔軟度與甩動誇張度",
    tech: ["MediaPipe Face Detector", "getUserMedia", "Canvas 2D", "Verlet 物理"],
    principle: [
      "FaceDetector 即時偵測每個人的頭部與鼻尖關鍵點，跨幀以最近鄰配對維持身分、並帶速度預測減少延遲",
      "單人繩只硬釘鼻尖、其餘節點自由垂掛（同雙手指尖繩作法），柔軟自然並隨頭晃動",
      "每個人找最靠近的另一個人，距離在門檻內就連線；雙人繩兩端釘頭頂、受重力在中間下垂成弧",
