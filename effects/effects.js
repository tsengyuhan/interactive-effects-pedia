...
window.EFFECTS = [
  ...
  },
  {
    ...
    title: "文字繩連連看",
    category: "身體動作",
    description: "輸入文字，文字繩從頭頂往上延伸再垂下；多人時連接最靠近的兩顆頭、文字沿拱形弧線流動，距離太遠會斷開",
    instructions: "面對鏡頭並輸入文字。只有你一人時，文字繩一端釘在頭頂，柔軟地往上延伸到頭頂上方一個無形的點，再從那裡受重力垂下並隨你晃動；出現其他人時，文字繩會連到最靠近你的人的頭頂、拱成一道弧並讓文字持續流動，超過最遠連接距離就斷開成各自垂下的繩。可調文字大小、疏密、粗細、顏色、最遠連接距離、重力、單人繩長度、無形錨點高度、拱起高度與文字流動速度",
    tech: ["MediaPipe Face Detector", "getUserMedia", "Canvas 2D", "Verlet 物理"],
    principle: [
      "FaceDetector 即時偵測畫面中每個人的頭部，跨幀以最近鄰配對維持身分",
      "單人繩用 Verlet：只硬釘頭頂、錨點以軟拉牽往頭頂上方的無形點，整條保持柔軟並隨頭晃動",
      "每個人找最靠近的另一個人，距離在門檻內就連線；雙人繩不受重力，是往上拱起的固定弧線且文字沿弧流動",
