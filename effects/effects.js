...
window.EFFECTS = [
  ...
  },
  {
    ...
    title: "聲音煙火",
    category: "聲音互動",
    description: "對麥克風發聲或打鼓，純黑畫面下方就發射一發煙火：寫實貓咪頭碎成貓形粒子，或一束數位雜訊撕裂消逝",
    instructions: "對著麥克風打鼓、拍手或發聲。貓咪煙火風格會隨機射出一隻貓（橘虎斑、賓士、布偶、暹羅），一路變大並逐格演出牠的專屬動作，到頂點時整張臉碎成粒子、定格成貓頭形狀再散開；數位雜訊風格則射出一束掃描線訊號柱，炸開成撕裂條與馬賽克方塊後迅速消逝。可調視覺風格、觸發音量、煙火大小與顏色",
    ...
    principle: [
      ...
      "爆炸從貓咪圖本身長出來：縮到 30×30 取樣，每個不透明像素換一顆帶原色的粒子，先定格成貓頭剪影再散開",
      "數位雜訊風格用水平掃描線堆出訊號柱，青與洋紅各畫一份偏移重影做色差，拖尾覆蓋加重讓它爆完就消失"
    ],
