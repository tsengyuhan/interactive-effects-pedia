...
window.EFFECTS = [
  ...
  },
  {
    ...
    title: "文字繩連連看",
    category: "身體動作",
    description: "輸入文字，文字繩從頭頂自由垂掛、稍微偏向一側；多人時連接最靠近的兩顆頭並受重力下垂成弧，距離太遠會斷開",
    instructions: "面對鏡頭並輸入文字。只有你一人時，文字繩固定在頭頂、整條柔軟自由垂下並稍微偏左或偏右（不正面擋臉），隨你晃動；出現其他人時，文字繩會連到最靠近你的人的頭頂、受重力在中間下垂成弧，超過最遠連接距離就斷開成各自垂下的繩。可調文字大小、疏密、粗細、顏色、最遠連接距離、重力與單人繩長度",
    tech: ["MediaPipe Face Detector", "getUserMedia", "Canvas 2D", "Verlet 物理"],
    principle: [
      "FaceDetector 即時偵測畫面中每個人的頭部，跨幀以最近鄰配對維持身分",
      "單人繩只硬釘頭頂、其餘節點自由垂掛（同雙手指尖繩作法），柔軟自然並加一點側向力偏向一側",
