...
window.EFFECTS = [
  ...
  },
  {
    ...
    title: "聲音煙火",
    category: "聲音互動",
    description: "對麥克風發聲或打鼓，畫面下方就發射一顆貓咪頭，飛到最高點時綻放成煙火",
    instructions: "對著麥克風打鼓、拍手或發聲；每個鼓點會射出一顆貓咪頭，一路變大並逐格換表情，到頂點時炸開成火星。可調觸發音量、煙火大小與顏色",
    tech: ["Web Audio API", "getUserMedia", "Canvas 2D", "逐格動畫"],
    principle: [
      "麥克風波形算 RMS 得音量，只在跨過門檻的起音瞬間發射，90 毫秒不應期讓鼓點能連發",
      "頻譜重心代表聲音明亮度，決定貓咪飛到多高；音量決定貓咪大小與炸開的火星數量",
      "整套模擬固定跑 12 fps，貓咪的 6 張油畫序列圖依飛行進度換格，做出逐格動畫的頓挫感",
      "畫面每格疊半透明黑底而非清空，火星自然留下拖尾"
    ],
