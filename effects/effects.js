...
window.EFFECTS = [
  ...
  },
  {
    ...
    instructions: "面對鏡頭並輸入文字。只有你一人時，文字繩一端黏在你的鼻子上、另一端柔軟自由垂下，會隨著頭移動而晃動；出現其他人時，文字繩會連到最靠近你的人的頭頂、受重力在中間下垂成弧，超過最遠連接距離就斷開成各自垂下的繩。可調文字大小、疏密、粗細、顏色、最遠連接距離、重力、單人繩長度與晃動柔軟度",
