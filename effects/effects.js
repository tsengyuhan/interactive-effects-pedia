...
window.EFFECTS = [
  ...
  },
  {
    ...
    title: "玩弄文字於指尖",
    category: "身體動作",
    description: "輸入文字，字粒會沿手指爬行、垂掛，或在雙手間連成文字繩",
    instructions: "在上方輸入文字；可調整字體大小、顏色、粗細、緊密度與重力。單手時字粒從手腕爬上每根手指，越過指尖後向下垂掛並淡出；雙手時文字繩會連接兩手對應指尖",
    tech: ["MediaPipe Hands", "getUserMedia", "Canvas 2D", "Verlet 物理"],
    principle: [
      "MediaPipe 手部模型即時取得手腕、指節與指尖座標",
      "單手時每根手指維持一串字粒，依弧長從手腕往指尖推進，過指尖後垂下並在底部淡出",
      "雙手時沿用 Verlet 節點繩，固定兩手對應指尖，靠重力與距離約束產生下垂和甩動"
    ],
