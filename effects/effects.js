...
window.EFFECTS = [
  ...
  },
  {
    ...
    title: "爆炸頭",
    category: "身體動作",
    description: "把你的臉變成繫在地上小花莖上的立體氣球，打氣直到爆炸",
    instructions: "左右移頭或歪頭帶動氣球與小花擺動；連點打氣，碎片全部落地後才能重置。繩長可調 0.6–2.5 倍，另可調主色調、充氣速度、最大尺寸與魚眼程度。",
    tech: ["MediaPipe Image Segmenter", "MediaPipe Face Detector", "WebGL", "Canvas 2D", "Web Audio API", "getUserMedia"],
    principle: [
      "本地模型擷取即時五官，貼滿不透明立體氣球；兩面牆與地板自動配色，氣球繩綁在從地板長出的小花莖上。",
      "氣球從花莖綁點垂直上浮，左右移頭與歪頭會讓整朵花跟著繩子擺動；繩長 0.6–2.5 倍，繩長約束、阻尼與微風讓球自然回穩。",
