...
window.EFFECTS = [
  ...
  },
  {
    ...
    instructions: "面對鏡頭，伸出食指、收起中指與無名指，停住約半秒，指尖發光後就能在空中畫一個封閉形狀；路徑閉合後發光 1 秒，那塊畫面便掉落，碎片會互相碰撞彈跳、堆在畫面底部約 8 秒後淡出；洞裡透出套用特效的即時畫面。可連續切好幾刀，洞會累積，按右上角「重置世界」復原。可選洞內特效（科技像素／動態亂碼／印刷拼貼／色塊版畫），並調整特效顆粒與掉落速度",
    ...
    principle: [
      ...
      "碎片以凸包剛體交給 Matter.js 模擬：依形狀翻倒、彈跳、堆疊，支撐消失自動掉落，落定 8 秒後淡出；洞是裁切窗口加內陰影，透出特效版即時畫面",
